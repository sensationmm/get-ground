...
import { RawComponent as PrivacyPolicy, ModalService } from './privacypolicy';
...
describe('<PrivacyPolicy />', () => {
  ...
  beforeEach(() => {
    wrapper = setup(PrivacyPolicy, props);
    jest.spyOn(wrapper.instance(), 'getBlobForDownload');
    component = findByTestAttr(wrapper, 'container-privacy');
  });
  ...
  test('fetches content', () => {
    ...
    expect(ModalService.fetchModalContent).toHaveBeenCalledWith('Privacy Policy');
