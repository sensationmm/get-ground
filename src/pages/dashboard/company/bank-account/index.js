...
class BankAccount extends Component {
  ...
  render() {
    ...
    let company, groupedTransactions, transactionDates, address;

    if ( activeCompany  ) {
      company = getByValue(companies, 'id', activeCompany);
      groupedTransactions = company.bank_account.transactions.reduce((accum, { date, name, sum, balance }) => {
      ...
      address = company.property_address.address;
    }
      ...
      <Layout secure>
        <div className="company-overview" data-test="component-bank-account">
          ...
          <div className="bank-header">
            ...
            { address.premise } { address.street }, { address.postcode }
